...
use CRICorsi\Includes\User_Roles; // <-- RIATTIVATO
...
final class CRI_Corsi {
    ...
    private function init_plugin(): void {
        ...
        // Classe che stiamo ri-testando
        new User_Roles(); // <-- RIATTIVATO
    }
...
// **RIATTIVATO**: Registra l'hook di attivazione per creare il ruolo utente.
